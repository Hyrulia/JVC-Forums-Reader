...
public class DdbDialog extends Dialog
{
	...
	private String formDataPage, formDataK, formDataT, modeValue;

	public DdbDialog(Context context, JvcPost post, String modeValue)
	{
		super(context);

		setTitle(context.getResources().getString(R.string.ddbDialogTitle));
		...
		if(isForumJV)
			url = post.getTopic().getForum().getBaseUrl();
		else
			url = "http://www.jeuxvideo.com/";
		url += "cgi-bin/jvforums/avertir_moderateur.cgi";
	...
	private class LoadDdbFormTask extends AsyncTask<Void, Void, String>
	{
		protected String doInBackground(Void... voids)
		{
			try
			{
				...
				m = PatternCollection.extractDdbFormData.matcher(content);
				if(!m.find())
